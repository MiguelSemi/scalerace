                ...
                <?php
                 while($row = $result->fetch_assoc()) {
                    ...
                    <div class="product">
                        ...
                        <p><a href="eliminar.php?id=<?php echo $row['id']; ?>&nombre=<?php echo $row['nombre']; ?>&precio=<?php echo $row['precio']; ?>">Eliminar</a></p>
                        <p><a href="modificar.php?id=<?php echo $row['id']; ?>&nombre=<?php echo $row['nombre']; ?>&precio=<?php echo $row['precio']; ?>">Modificar</a></p>
                    </div>
                    <?php
                 }
                ?>
...
<!-- Footer con acciones para desloguearse y agregar un nuevo producto -->
<div class="footer">
